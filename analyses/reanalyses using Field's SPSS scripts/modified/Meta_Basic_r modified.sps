...
* DATA: before running this script in the SPSS syntax viewer, open 'data/SPSS analyses/data from Vahey et al.'s forest plot.sav' in SPSS.

*RENAME VARIABLES r = rxy.
